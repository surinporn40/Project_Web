...
class NewtonDiv extends Component{
    constructor() {
        super();
        x = []
        y = []
    ...
    render(){
        ...
        return (
            <div style={{padding: "30px" }}>
                 <div class="content ">
                    <h2>NEWTON'S DIVIDED </h2>
                    <h2>DIFFERENCES INTERPOLATION</h2>
                 </div>
                        ...
                        >
                            ...
                            {this.state.showTableInput &&
                                <div>
                                    ...
                                    <br />
                                    <h4 style={{color:"white"}}>interpolatePoint {parseInt(this.state.interpolatePoint) === 2 ? "(Linear)" :
